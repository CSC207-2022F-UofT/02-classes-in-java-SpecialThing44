...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param str_1 the first half of this Silly instance's name.
     * @param str_2 the second half of this Silly instance's name.
     */
    public Silly(String str_1, String str_2) {this.name = str_1 + str_2;}
